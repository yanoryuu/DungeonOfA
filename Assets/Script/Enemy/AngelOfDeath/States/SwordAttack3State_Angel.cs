...
public class SwordAttack3State_Angel : IAngelState
{
    public void EnterState(Enemy_Angel _enemy)
    {
        Debug.Log("Entered SwordAttack3State_Angel");
        AnimatorCommon.SetAction("SwordAttack3",_enemy.Animator);
    }
    ...
    {
        AnimatorCommon.ResetAction("SwordAttack3", _enemy.Animator);
    }
}
