...
public class SwordAttack2State_Angel : IAngelState
{
    public void EnterState(Enemy_Angel _enemy)
    {
        Debug.Log("Entered SwordAttack2State_Angel");
        AnimatorCommon.SetAction("SwordAttack2",_enemy.Animator);
        _enemy.AngelAttackManager.SwordAttack2();
    }
